...
func (_q *AdminQuery) QuerySessions() *SessionQuery {
...
func (_q *AdminQuery) WithSessions(opts ...func(*SessionQuery)) *AdminQuery {
	query := (&SessionClient{config: _q.config}).Query()
...
func (_q *AdminQuery) loadSessions(ctx context.Context, query *SessionQuery, nodes []*Admin, init func(*Admin), assign func(*Admin, *Session)) error {
