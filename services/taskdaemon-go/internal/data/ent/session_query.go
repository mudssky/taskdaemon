...
func (_q *SessionQuery) QueryAdmin() *AdminQuery {
...
func (_q *SessionQuery) WithAdmin(opts ...func(*AdminQuery)) *SessionQuery {
	query := (&AdminClient{config: _q.config}).Query()
...
func (_q *SessionQuery) loadAdmin(ctx context.Context, query *AdminQuery, nodes []*Session, init func(*Session), assign func(*Session, *Admin)) error {
