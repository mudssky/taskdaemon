...
type Task struct {
	...
	RunnerType task.RunnerType `json:"runner_type,omitempty"`
	// RunnerConfig holds the value of the "runner_config" field.
	RunnerConfig map[string]interface{} `json:"runner_config,omitempty"`
	// TimeoutSeconds holds the value of the "timeout_seconds" field.
	TimeoutSeconds int `json:"timeout_seconds,omitempty"`
	// OverlapPolicy holds the value of the "overlap_policy" field.
	OverlapPolicy task.OverlapPolicy `json:"overlap_policy,omitempty"`
...
func (e TaskEdges) RunsOrErr() ([]*Run, error) {
	if e.loadedTypes[0] {
		return e.Runs, nil
	}
...
func (*Task) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case task.FieldID, task.FieldTimeoutSeconds:
			values[i] = new(sql.NullInt64)
		case task.FieldName, task.FieldDescription, task.FieldCronExpression, task.FieldTimezone, task.FieldRunnerType, task.FieldOverlapPolicy:
